...
`SET_CIRCUIT_NAME`, `SET_CIRCUIT_NUMBER`, `SET_TRACK_LENGTH`, `ADD_SEGMENT`, `INSERT_ABOVE`, `INSERT_BELOW`, `UPDATE_SEGMENT`, `CHANGE_TYPE`, `MOVE_UP`, `MOVE_DOWN`, `DELETE_SEGMENT`, `LOAD_JSON`, `NEW`, `APPLY_OFFSET`
